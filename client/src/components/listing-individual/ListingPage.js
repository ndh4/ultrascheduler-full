    ...
    return (
        <div>
            ...
            <div class="flex flex-row w-full">
                <div class="flex flex-col w-1/2 items-center justify-center my-10">
                ...
                <div class="flex flex-col w-2/5 items-left my-10 pl-5">
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <div class="flex flex-row w-1/2 space-x-6 justify-center items-center">
                            <div class="w-1/3 flex flex-col items-center">
                                <a href={"mailto:" + "test@email.com"} class="transform transition hover:bg-blue-500 duration-500 flex items-center justify-center rounded-full bg-primary-teal w-9 h-9 mb-1"> {/* takes seller email from backend */}
                            ...
                            <div class="w-1/3 flex flex-col items-center" href="">
                                <a href={"facebook.com/" + "user.name" + "/"} class="transform transition hover:bg-blue-500 duration-500 flex items-center justify-center rounded-full bg-primary-teal w-9 h-9 mb-1"> {/* takes FB username from backend */}
                            ...
                            <div class="flex w-1/3 flex-col items-center" href="">
                                <a href="" class="transform transition hover:bg-blue-500 duration-500 flex items-center justify-center rounded-full bg-primary-teal w-9 h-9 mb-1"> {/* not sure about this one, phone #? */}
                                    <svg class="text-white w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
